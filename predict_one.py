...
# python predict_one.py --exp 220610_162631 --validation --epochs 3
# python predict_one.py --exp 220607_163752 --single_image --validation --epochs 30
...
def predict(model, device, save_dir, single_image=False, is_validation=False):
    ...
    fnames = sorted(test_dataset.sem_list)
...
def get_args():
    ...
    parser.add_argument('--exp', type=str, help='experiment date', default='first')
